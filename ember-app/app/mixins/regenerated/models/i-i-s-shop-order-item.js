...
import {
  ...
  belongsTo,
  hasMany,
} from "ember-flexberry-data/utils/attributes";
...
export let Model = Mixin.create({
  ...
  order: DS.belongsTo("i-i-s-shop-order", {
    inverse: "orderItem",
    async: false,
  }),
});
...
export let ValidationRules = {
  amount: {
    descriptionKey:
      "models.i-i-s-shop-order-item.validations.amount.__caption__",
    validators: [
      validator("ds-error"),
      validator("number", {
        allowString: true,
  ...
  priceWTaxes: {
    descriptionKey:
      "models.i-i-s-shop-order-item.validations.priceWTaxes.__caption__",
    validators: [
      validator("ds-error"),
  ...
  totalSum: {
    descriptionKey:
      "models.i-i-s-shop-order-item.validations.totalSum.__caption__",
    validators: [
      validator("ds-error"),
      validator("number", { allowString: true, allowBlank: true }),
    ],
  ...
  product: {
    descriptionKey:
      "models.i-i-s-shop-order-item.validations.product.__caption__",
    validators: [validator("ds-error")],
  },
  order: {
    descriptionKey:
      "models.i-i-s-shop-order-item.validations.order.__caption__",
  ...
  modelClass.defineProjection("OrderItemE", "i-i-s-shop-order-item", {
    ...
    product: belongsTo(
      ...
      "Товар",
      {
        ...
        price: attr("~", { index: 6, hidden: true }),
      },
